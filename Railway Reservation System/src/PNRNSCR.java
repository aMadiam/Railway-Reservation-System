...
public class PNRNSCR extends JFrame  
{  
	JMenu menu, submenu;  
	...
	Color c3 = Color.BLUE;
     ...
     PNRNSCR(){  
           ...
           ImageIcon img = new ImageIcon("img/PNR.png");
        ...
        final DefaultListModel<String> l11 = new DefaultListModel<>();           
          l11.addElement("New Clark City (NCC)");  
          l11.addElement("Blumentritt");  
          l11.addElement("Laon Laan");  
          l11.addElement("España");  
          l11.addElement("Santa Mesa");  
          l11.addElement("Pandacan");  
          l11.addElement("Paco");  
          l11.addElement("San Andres");  
          l11.addElement("Vito Cruz");
          l11.addElement("Buendia");
          l11.addElement("Dela Rosa");
          l11.addElement("Pasay Road");  
          l11.addElement("EDSA");  
          l11.addElement("Nichols");  
          l11.addElement("FTI");  
          l11.addElement("Bicutan");  
          l11.addElement("Sucat");  
          l11.addElement("Alabang");  
          l11.addElement("Muntinlupa");  
          l11.addElement("San Pedro");
          l11.addElement("Pacita MG");
          l11.addElement("Golden City 1");  
          l11.addElement("Biñan");  
          l11.addElement("Santa Rosa");  
          l11.addElement("Cabuyao");
          l11.addElement("Mamatid");
          l11.addElement("Calamba");
          ...
          l21.addElement("Laon Laan");  
          l21.addElement("España");  
          l21.addElement("Santa Mesa");  
          l21.addElement("Pandacan");  
          l21.addElement("Paco");  
          l21.addElement("San Andres");  
          l21.addElement("Vito Cruz");
          l21.addElement("Buendia");
          l21.addElement("Dela Rosa");
          l21.addElement("Pasay Road");  
          l21.addElement("EDSA");  
          l21.addElement("Nichols");  
          l21.addElement("FTI");  
          l21.addElement("Bicutan");  
          l21.addElement("Sucat");  
          l21.addElement("Alabang");  
          l21.addElement("Muntinlupa");  
          l21.addElement("San Pedro");
          l21.addElement("Pacita MG");
          l21.addElement("Golden City 1");  
          l21.addElement("Biñan");  
          l21.addElement("Santa Rosa");  
          l21.addElement("Cabuyao");
          l21.addElement("Mamatid");
          l21.addElement("Calamba");
          ...
          f.setTitle("Philippine National Railways/PNR North South Commuter Railway (Tutuban to Calamba)");
          f.setSize(550,650);  
          f.setLayout(null);  
          f.setVisible(true); 
          c.setForeground(c1); 
